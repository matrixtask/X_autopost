...
function prepareEditorialCouncil(stage, material, purpose, sources, contextId) {
  ...
  var shared = [
    ...
    'turnでclarification_requested=trueなら、本人はまだ回答しておらず質問の説明を求めている。新しい取材や追問を提案せず、今の問いの曖昧な語・対象・想定場面・意図を特定し、答える切り口を補う方針にする。previous_clarificationがあれば同じ説明を繰り返さない。仮の例と本人の実体験は区別する。',
